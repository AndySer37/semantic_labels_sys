...
"""
brand_list = ['background','crayons','kleenex','vanish','milo','raisins','andes','pocky','stax','hunts','3m',\
        '90_crayons','90_kleenex','90_vanish','90_milo','90_raisins','90_andes','90_pocky','90_stax','90_hunts','90_3m',\
        '180_crayons','180_kleenex','180_vanish','180_milo','180_raisins','180_andes','180_pocky','180_stax','180_hunts','180_3m',\
        '270_crayons','270_kleenex','270_vanish','270_milo','270_raisins','270_andes','270_pocky','270_stax','270_hunts','270_3m','barcode']
                ...
                if  object_['name'] in brand_list and object_['deleted'] == '0':
                    ...
                    for i in range(len(brand_list)):
                        if brand_list[i] == object_['name']:
                            cv2.fillConvexPoly(mask, poly_vertice, i*6)
