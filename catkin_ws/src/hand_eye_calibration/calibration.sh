...
OPEN_TAG="roslaunch apriltags_ros cali_cam2.launch"
...
gnome-terminal --geometry=100x50 --working-directory=$DIR \
                                 ...
                                 --tab -e "bash -c \"sleep 2s; $SET_VARIABLES; $OPEN_TF; exec bash\"" \
                                 --tab -e "bash -c \"sleep 2s; $SET_VARIABLES; $OPEN_TAG; exec bash\"" \
